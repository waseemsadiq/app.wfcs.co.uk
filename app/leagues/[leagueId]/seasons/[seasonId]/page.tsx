...
import { getLeague, getSeason } from "@/lib/actions/league-actions"
...
export default async function SeasonPage({
  ...
  const season = await getSeason(params.leagueId, params.seasonId)
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          ...
          <Button variant="outline" asChild>
            <Link href={`/leagues/${params.leagueId}`}>Back to League</Link>
          </Button>
        </div>
      </header>
          ...
          <Card>
            ...
            <CardContent>
              <Suspense fallback={<StandingsTableSkeleton />}>
                <StandingsTable leagueId={params.leagueId} seasonId={params.seasonId} />
              </Suspense>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent>
              <Suspense fallback={<div>Loading fixtures...</div>}>
                <FixturesList leagueId={params.leagueId} seasonId={params.seasonId} />
              </Suspense>
            </CardContent>
          </Card>
        </TabsContent>
